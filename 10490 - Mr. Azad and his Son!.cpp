...
int status[100000005];
vector<int>prime;
void seive(){
    for(int i=4; i<100000005; i+=2) status[i]=1;
    for(int i=3; i*i<=100000005; i+=2){
        if(status[i]==0){
            for(int j=i*i; j<100000005; j+=(i+i)){
                status[j]=1;
            }
        }
    }
    for(int i=2; i<100000005; i++) if(!status[i]) prime.push_back(i);
}
